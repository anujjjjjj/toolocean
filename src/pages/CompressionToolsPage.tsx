...
const compressionTools = [
  ...
  { id: "gzip-decompress", name: "Gzip Decompress", description: "Decompress gzip data", icon: FileUp, color: "from-green-500 to-emerald-500" },
  { id: "lz-string-compress", name: "LZ-String Compress", description: "Compress for URLs and localStorage", icon: Archive, color: "from-purple-500 to-violet-500" },
];
...
const CompressionToolsPage = () => {
  ...
  const filteredTools = compressionTools.filter(
    (tool) =>
        ...
        <section className="text-center py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Compress and decompress data. Gzip, LZ-String, and more.
            </p>
          </div>
        </section>
            ...
            {filteredTools.map((tool) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => navigate(`/compression-tools/${tool.id}`)}
                >
        ...
        <section className="py-12">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground text-sm">Data never leaves your browser.</p>
            </div>
            <div className="space-y-3">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary/10">
              ...
              <p className="text-muted-foreground text-sm">Powered by pako and LZ-String.</p>
            </div>
            <div className="space-y-3">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary/10">
